            ...
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="ui-media-object%20mr-3.html">Media Object</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="recent-comment m-t-15">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object mr-3" src="{{asset('images/avatar/2.png')}}" alt="..."></a>
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object mr-3" src="{{asset('images/avatar/3.png')}}" alt="..."></a>
                                    </div>
                                    <div class="media-body">
